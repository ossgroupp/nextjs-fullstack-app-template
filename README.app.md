All code from this tutorial as a complete package is available in [this repository](https://github.com/ossgroupp/nextjs-fullstack-app-template).
...
If you wish to align the [repository](https://github.com/ossgroupp/nextjs-fullstack-app-template) with the start of this tutorial, clone the repository and `git checkout 6630ca95c25e66d7b6c7b1aad92151b481c1b9c5`.
...
We also create all of our components off a base template that includes styles, stories and mock data. You can get that template from [here](https://github.com/ossgroupp/nextjs-fullstack-app-template/tree/main/components/templates/base).
...
If you want to align with this step of the tutorial, clone the [repository](https://github.com/ossgroupp/nextjs-fullstack-app-template) and use `git checkout 6630ca95c25e66d7b6c7b1aad92151b481c1b9c5`.
...
If you want to align with this step of the tutorial, clone the [repository](https://github.com/ossgroupp/nextjs-fullstack-app-template) and use `git checkout 676a71b50755d859f46a12e54f8ea3484bf1f208`.
...
If you want to align with this step of the tutorial, clone the [repository](https://github.com/ossgroupp/nextjs-fullstack-app-template) and use `git checkout 9ff325aceb0e2096fa618d78489beec2c00dea12`.
...
If you want to align with this step of the tutorial, clone the [repository](https://github.com/ossgroupp/nextjs-fullstack-app-template) and use `git checkout 3c4cf387cfd9112fe26c5dd268c293d7c1c00f5f`.
...
If you want to align with this step of the tutorial, clone the [repository](https://github.com/ossgroupp/nextjs-fullstack-app-template) and use `git checkout f7321a266c51528d2369bf5d5862bc4ace4fdfcb`.
...
If you want to align with this step of the tutorial, clone the [repository](https://github.com/ossgroupp/nextjs-fullstack-app-template) and use `git checkout `.
...
Remember that all code from this tutorial as a complete package is available in [this repository](https://github.com/ossgroupp/nextjs-fullstack-app-template).
